  ...
  <div class="grid grid-cols-12 h-screen">
    <div class="col-span-9 grid grid-cols-12">
      <div class="col-span-2 flex justify-center py-8 px-4 bg-[#f6f7f8]">
        <div class="flex-col items-center">
          <img src="" alt="logo" class="h-16 w-32" />
          <nav>
            <ul class="py-5">
            <li class="">
              <router-link
      ...
      <div class="col-span-10 p-8">
        ...
        <div class="grid grid-cols-12 gap-8 h-96 mt-12">
          ...
          <div  class="image col-span-4 h-80 py-10 px-7 rounded-3xl">
            <div>
              <h2 class="text-3xl font-semibold hover:text-white"> {{currentTomorrow()}} </h2>
              <h3 class="text-2xl "> {{city}} </h3>
            </div>
            <div class="mt-16" >
              <p class="text-2xl font-extrabold"> {{ weather.main }} </p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="bg-[#F6F8FD] col-span-3 py-8 px-10" v-if="typeof current.weather != 'undefined'">
      ...
      <div class="bg-[#1D273B] flex items-center px-7 py-2 rounded-2xl">
        ...
        <div class="ml-7">
          <div class="flex justify-center items-center mt-6 mb-1.5">
            <div v-if="3 > uvi">
              <p class="text-white text-xl font-semibold mr-4"> {{uvi}} UVI </p>
              <p class="bg-[#2b792b] text-base text-white p-2 rounded-lg text-center box-content">Low</p>
              <p class="text-white mt-3">Low risk of from UV rays</p>
            </div>
            <div v-else-if=" 5 > uvi ">
              <p class="text-white text-xl font-semibold mr-4"> {{uvi}} </p>
              <p class="bg-[#f5f52e] text-base text-white p-2 rounded-lg text-center box-content">Moderate</p>
              <p class="text-white mt-3">Moderate risk of from UV rays</p>
            </div> 
            <div v-else-if=" 8 > uvi ">
              <div class="flex justify-around items-center">
              <p class="text-white text-xl font-semibold mr-4"> {{uvi}} UVI </p>
              <p class="bg-[#e98e2e] text-base text-white p-2 rounded-lg text-center box-content">High</p>
              </div>
              <p class="text-white mt-3">High risk of from UV rays</p>
            </div> 
            <div v-else-if=" 11 > uvi ">
              <p class="text-white text-xl font-semibold mr-4"> {{uvi}} </p>
              <p class="bg-[#e92727] text-base text-white p-2 rounded-lg text-center box-content">Very High</p>
              <p class="text-white mt-3">Very high risk of from UV rays</p>
            </div> 
            <div v-else >
              <p class="bg-[#481262] text-base text-white p-2 rounded-lg text-center box-content">Extreme</p>
              <p class="text-white mt-3">Extreme risk of from UV rays</p>
            </div> 
          </div>
        </div>
      </div>
